          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span onClick={handleForgotPassword} className="text-xs text-supportbox hover:underline cursor-pointer">
                  Esqueceu a senha?
                </span>
              </div>
              <Input
            ...
            <Button type="submit" className="w-full bg-supportbox hover:bg-supportbox-dark" disabled={isLoading}>
              {isLoading ? "Entrando..." : "Entrar"}
            </Button>
          </form>
        </CardContent>
        <CardFooter className="flex justify-center border-t border-supportbox/10 pt-4">
          <p className="text-xs text-muted-foreground">© 2023 SupportBox. Todos os direitos reservados.</p>
        </CardFooter>
      </Card>
      ...
      <Dialog open={forgotPasswordOpen} onOpenChange={setForgotPasswordOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogTitle className="text-center">Instruções Enviadas</DialogTitle>
            <DialogDescription className="text-center pt-2">
              As instruções para redefinição de senha foram enviadas para o e-mail cadastrado:
